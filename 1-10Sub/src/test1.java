...
public class test1 {
	public static void main(String[] args) {
		...
		int[] numd = {1, 3, 5, 7, 9};
		int[] numd2 = Arrays.copyOf(numd, numd.length);
		
		System.out.println(Arrays.toString(numd2));
		//改行
		...
		for(Map.Entry<String, String> car2 : car.entrySet()) {
			System.out.println(car2.getKey() + "：" + car2.getValue());
		}
		//改行
